...
public class MeTodoController {
    ...
    public ResponseObject getAllTodoByIdPeriodAndStatusTodo(@RequestParam("idPeriod") String idPeriod,
        ...
        return new ResponseObject(meTodoService.getToDoByPeriodAndTodoList(idPeriod, idTodoList));
    }
    ...
    public ResponseObject countTodoByTodoListAllProject(@RequestParam("projectId") String projectId,
        ...
        return new ResponseObject(meTodoService.countTodoByTodoListAllProject(projectId, todoListId));
    }
    ...
    public ResponseObject countTodoByMemberAllProject(@RequestParam("projectId") String projectId,
        ...
        return new ResponseObject(meTodoService.countTodoByMemberAllProject(projectId, memberId));
    }
    ...
    public ResponseObject countTodoByLabelAllProject(@RequestParam("projectId") String projectId,
                                                     @RequestParam("labelProjectId") String labelProjectId) {
        return new ResponseObject(meTodoService.countTodoByLabelAllProject(projectId, labelProjectId));
    }
    ...
    public ResponseObject countTodoByTodoListPeriod(@RequestParam("projectId") String projectId,
                                                    ...
                                                    @RequestParam("todoListId") String todoListId) {
        return new ResponseObject(meTodoService.countTodoByTodoListPeriod(projectId, periodId, todoListId));
    }
    ...
    public ResponseObject countTodoByMemberPeriod(@RequestParam("projectId") String projectId,
                                                  @RequestParam("periodId") String periodId,
                                                  @RequestParam("memberId") String memberId) {
        return new ResponseObject(meTodoService.countTodoByMemberPeriod(projectId, periodId, memberId));
    }
    ...
    public ResponseObject countTodoByLabelPeriod(@RequestParam("projectId") String projectId,
                                                 @RequestParam("periodId") String periodId,
                                                 @RequestParam("labelProjectId") String labelProjectId) {
        return new ResponseObject(meTodoService.countTodoByLabelPeriod(projectId, periodId, labelProjectId));
    }
