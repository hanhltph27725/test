app.config(function ($routeProvider, $locationProvider) {
  ...
  $routeProvider
    ...
    .when("/member/project/dashboard/:id", {
      templateUrl: "./pages/member/dashboard.html",
      controller: MemberDashboardController,
      css: "../css/custom/member/dashboard.css",
      reloadOnSearch: false,
    })
    ...
    .when("/stakeholder/projects/detail", {
      templateUrl: "./pages/stakeholder/stakeholder-projects-detail.html",
      controller: StakeholderProjectDetailController,
      css: "../css/custom/stakeholder/stakeholder-projects-detail.css",
    })
    .otherwise({
